...
const evaluations = [
  {
    period: "Q1 2026", date: "15/03/2026", score: 4.5, max: 5,
    evaluator: "Dr. António Ferreira",
    status: "Concluída", nextReview: "01/07/2026",
    criteria: [
      { label: "Desempenho Técnico",     score: 4.5 },
      { label: "Relações Interpessoais", score: 4.8 },
      { label: "Iniciativa & Liderança", score: 4.2 },
      { label: "Cumpimento de Prazos",   score: 4.5 },
      { label: "Adaptabilidade",         score: 4.6 },
    ],
    comment: "Excelente desempenho no período. Demonstrou elevada capacidade de gestão de relações bilaterais e liderança de equipa.",
  },
  {
    period: "Q3 2025", date: "20/09/2025", score: 4.3, max: 5,
    evaluator: "Dra. Carla Monteiro",
    status: "Concluída", nextReview: "15/03/2026",
    criteria: [
      { label: "Desempenho Técnico",     score: 4.3 },
      { label: "Relações Interpessoais", score: 4.6 },
      { label: "Iniciativa & Liderança", score: 4.0 },
      { label: "Cumpimento de Prazos",   score: 4.4 },
      { label: "Adaptabilidade",         score: 4.2 },
    ],
    comment: "Bom desempenho. Recomenda-se maior proactividade em contextos multilaterais.",
  },
  {
    period: "Q1 2025", date: "18/03/2025", score: 4.1, max: 5,
    evaluator: "Dra. Carla Monteiro",
    status: "Concluída", nextReview: "20/09/2025",
    criteria: [
      { label: "Desempenho Técnico",     score: 4.0 },
      { label: "Relações Interpessoais", score: 4.4 },
      { label: "Iniciativa & Liderança", score: 3.8 },
      { label: "Cumpimento de Prazos",   score: 4.2 },
      { label: "Adaptabilidade",         score: 4.1 },
    ],
    comment: "Desempenho sólido. Evolução positiva nas relações interpessoais.",
  },
  {
    period: "Q3 2024", date: "22/09/2024", score: 3.9, max: 5,
    evaluator: "Dr. Mário Lopes",
    status: "Concluída", nextReview: "18/03/2025",
    criteria: [
      { label: "Desempenho Técnico",     score: 3.8 },
      { label: "Relações Interpessoais", score: 4.1 },
      { label: "Iniciativa & Liderança", score: 3.7 },
      { label: "Cumpimento de Prazos",   score: 4.0 },
      { label: "Adaptabilidade",         score: 3.9 },
    ],
    comment: "Desempenho satisfatório. Sugerida participação em formação de liderança.",
  },
  {
    period: "Q2 2026", date: "—", score: null, max: 5,
    evaluator: "Dr. António Ferreira",
    status: "Em Curso", nextReview: "01/07/2026",
    criteria: [], comment: "",
  },
];

const chartData = [
  { period: "Q3 2024", nota: 3.9 },
  { period: "Q1 2025", nota: 4.1 },
  { period: "Q3 2025", nota: 4.3 },
      ...
      <div className="bg-white rounded-2xl shadow-sm p-5 mb-5">
        ...
        <ResponsiveContainer width="100%" height={160}>
          <AreaChart data={chartData} margin={{ top: 8, right: 16, bottom: 0, left: -20 }}>
            ...
            />
            <Area type="monotone" dataKey="nota" stroke="#3b82f6" strokeWidth={2} fill="url(#scoreGrad)" dot={{ r: 4, fill: "#3b82f6", strokeWidth: 0 }} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
              ...
              <div key={i} className="p-4">
                ...
                {ev.score && (
                  <div className="space-y-1.5 mt-3">
                    {ev.criteria.map((c, j) => (
                      <div key={j} className="grid grid-cols-[1fr_auto] items-center gap-3">
                        <div>
              ...
              <div key={i} className="p-4">
                <div className="flex items-start justify-between mb-2">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-400 mt-0.5">{t.duration} · {t.year}</p>
                  </div>
